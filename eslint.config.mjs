...
const markdownPreferencesRules = Object.values(markdownPreferences.rules);
const markdownRules = Object.entries(markdown.rules);

let markdownLinks = { rules: {} };
try {
  markdownLinks = await import("./src/index.ts");
} catch {
  // Fallback for environments that do not support dynamic import
  markdownLinks = await import("./lib/index.js");
}
const rules = Object.values(markdownLinks.rules);
...
const MD_LINKS = {
  ...
  ...Object.fromEntries(
    markdownPreferencesRules.map((rule) => [
    ...
    rules: {
      ...
      "markdown-preferences/heading-casing": [
        "error",
        {
          ...
          ignorePatterns: [String.raw`/^markdown-links\//u`],
        },
      ],
